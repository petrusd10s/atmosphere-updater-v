...
#define APP_VERSION "Atmosphere Updater: 0.5.1-F"
...
void printOptionList(int cursor)
{
    ...
    char *option_list[]      = {    "Full Atmosphere update (with Patches)", \
                                    "Add signature patches for Vanilla AMS (fusee-primary)", \
                                    "Update Hekate (for hekate / kosmos users)", \
                                    "Update app", \
                                    "Reboot (reboot to payload)" };

    char *description_list[] = {    "Update everything for Atmosphere with sigpatches ignoring .ini files", \
                                    "Update signatura patches for Vanilla Atmosphere", \
                                    "Update hekate", \
